...
from component.Fourier_modules import *
from component.evolution import Spatio_temporal_evolution
import math
import torch
...
from component.pscan import pscan
...
class Temporal_evo(nn.Module):
    ...
    def forward(self, x):
        B, T, C, H, W = x.shape # 时间步，通道，以及空间分辨率
        bias = x
...
if __name__ == '__main__':
    ...
    model = NMOModel(shape_in=(10, 1, 64, 64))  # Move the model to GPU
    outputs, rec_feature = model(inputs)
